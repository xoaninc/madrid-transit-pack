...
|---|---|---|---|---|---|---|
| `madrid-metro-estrecho` | Metro L1-L5 + Ramal | CAF Serie 3000 | 80 km/h | 4-6 coches de 14,9 m (59,94-89,38 m) | 5 % | 90 m |
| `madrid-metro-ancho` | Metro L6-L12 | Series 8000/9000 | 80 km/h | 3-6 coches de ~18 m (andenes hasta 115 m) | 5 % | 90 m |
| `madrid-metro-ligero` | ML1-ML3 | Alstom Citadis 302 | 70 km/h | 1-2 unidades de 32,5 m | 6,5 % | 25 m |
| `renfe-cercanias` | Cercanías Madrid | Renfe S/452 (Alstom X'Trapolis) | 140 km/h | 1-2 unidades de 6 coches (100/200 m) | 3,5 %* | 90 m |

\* Estimación de proyecto; no hay dato oficial publicado para la red de Cercanías.
...
- [Normativa Técnica Básica de Vía — Metro de Madrid 2017](https://www.alamys.org/wp-content/uploads/2021/04/Normativa-T%C3%A9cnica-B%C3%A1sica-de-V%C3%ADa-Metro-Madrid-2017.pdf) (radio mínimo 90 m, pendiente máxima 5 %)
